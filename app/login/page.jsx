...
export const metadata = {
  ...
  description: "Sign in to your Coco Delight account to manage orders, track academy progress, and more.",
};
    ...
    <main className="min-h-screen grid lg:grid-cols-2 bg-cream">
      ...
      <div className="flex items-center justify-center px-6 py-16 lg:py-0">
        <div className="w-full max-w-md">
          <Link href="/" className="flex flex-col leading-none mb-12 lg:hidden">
          ...
          <p className="text-cacao/65 font-light mb-10">
            Manage orders, track your academy progress, and revisit your
            saved designs.
          </p>
          ...
          <form className="space-y-6">
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              />
              <span className="text-sm text-cacao/70">Keep me signed in</span>
            </label>
          ...
          <p className="text-center text-sm text-cacao/65 mt-10">
            New to Coco Delight?{" "}
            <a href="/signIn" className="text-gold-dark font-medium hover:underline underline-offset-4">
              Create an account
            </a>
          </p>
        </div>
